...
### Env в Next.js (`.env` / `.env.local`)

```bash
EVENTS_SERVICE_URL=http://localhost:8081
EVENTS_SERVICE_API_KEY=replace-with-strong-key
```

### Быстрый пример отправки события из фронтенда
...
```
# java-micro-service-and-project
